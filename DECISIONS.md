...
- **Now / Names / Record tabs, call on the desk** — tabs stay. Hiding Names and Record behind header chips made the product smaller. Home still answers “what’s next, and have I made the call?” with Up / Down / Flat on the card. Tape is See all from Now. Settings is a gear. Retrieve no-tabs at git tag `desk`.
