...
- **One way to write a call** — Quick Note and Full Journal were two products. Direction is three big buttons; conviction is 1–5 taps; why / wrong-if are two sentences. Lock the call vs Save draft. Incomplete still never enters accuracy.
